...
exports.commands = {
	...
	credits: function (target, room, user) {
		let popup = "|html|" + "<font size=5 color=#0066ff><u><b>" + Config.serverName + " Credits</b></u></font><br />" +
			...
			"- " + WL.nameColor('Snorlax', true) + " (Development)<br />" +*/
			"<br />" +
	...
	pmallstaff: function (target, room, user) {
		...
		let pmName = ' ' + Config.serverNe + ' Server';
	...
	usercodes: function (target, room, user) {
		...
		let keys = Db.userType.keys(), codes = {3: '' + Config.serverName + ' Sysop', 4: 'Autoconfirmed', 5: 'Permalocked', 6: 'Permabanned'};
