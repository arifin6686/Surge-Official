...
exports.WL = {
	...
	//
	// usage: WL.messageSeniorStaff('Prince Sky is a confirmed user and they were banned from a public room. Assess the situation immediately.', '~Server')
	//
	...
	giveDailyReward: function (user) {
		...
		user.send('|popup||wide||html| <center><u><b><font size="3">' + Config.serverName + ' Daily Bonus</font></b></u><br>You have been awarded ' + reward + ' bucks.<br>' + showDailyRewardAni(reward) + '<br>Because you have connected to the server for the past ' + (reward === 1 ? 'Day' : reward + ' Days') + '.</center>');
	},
	makeCOM: function () {
